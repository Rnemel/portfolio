...
export const projects: Project[] = [
  {
    ...
    tagline:
      'Full-stack early seizure prediction system integrating smartwatch data, adaptive modelling, and proactive risk alerts.',
    clientType: 'enterprise',
    sector: 'Healthcare · Time-Series ML',
    category: 'ai-ml',
    overview:
      'A full-stack healthcare prediction system integrating smartwatch data for early seizure prediction. MEHAD is implemented as a working application, with backend services and a mobile app experience designed for real-world usage.',
    problem:
    ...
    approach:
      'Built an end-to-end pipeline from data ingestion to deployment-ready services: multi-modal signal preprocessing, adaptive modelling (CNN-LSTM), and a risk classification workflow that supports proactive alerts.',
    approachSteps: [
      'Led a 9-member team through the full project lifecycle in 5 months.',
      'Trained the model on data from 110 epilepsy patients, using 6 biometric signals.',
      'Built a FastAPI backend with 85+ endpoints and integrated OAuth-based smartwatch data ingestion.',
      'Developed an adaptive CNN-LSTM model achieving 83% accuracy and 0.80 AUC.',
      'Engineered a 3-tier risk classification (High / Medium / Low) with automated email alerts up to 30 minutes ahead.',
    ],
    impact:
      'Delivered a working full-stack application that turns multi-modal smartwatch signals into actionable early-risk insights, demonstrating end-to-end delivery across ML, backend services, and mobile experience.',
    metrics: [
      { label: 'Patients', value: '110 epilepsy patients' },
      { label: 'Signals collected', value: '6 biometric signals' },
      { label: 'Backend', value: '85+ FastAPI endpoints' },
      { label: 'Model accuracy', value: '83% accuracy' },
      { label: 'Model AUC', value: '0.80 AUC' },
      { label: 'Alert lead time', value: 'Up to 30 minutes ahead' },
    ],
    impactLevel: 'high',
    stack: ['Python', 'FastAPI', 'Flutter', 'Docker', 'OAuth', 'CNN-LSTM'],
  ...
  },
  {
    ...
    impact:
      'Built an enterprise platform centralising student internship registration and automating internal staff workflows across departments, improving visibility and decision speed.',
    metrics: [
      { label: 'Manual effort reduction', value: '40% reduction' },
      { label: 'Delivery', value: 'Reporting dashboards + end-user documentation' },
    ],
    impactLevel: 'high',
    stack: [
      'Next.js',
